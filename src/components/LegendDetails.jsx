...
const LegendDetails = ({ legend, onNext, showGallery, onToggleGallery }) => {
  ...
  return (
    <div className="w-full lg:w-[420px] h-auto lg:h-full flex flex-col justify-between px-8 py-12 lg:pt-36 lg:pb-20 z-40 transition-colors duration-700 lg:overflow-y-auto custom-scrollbar">
